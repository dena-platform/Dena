...
public enum ErrorCode {
    ...
    OBJECT_ID_INVALID_EXCEPTION("com.dena.platform.restapi.exception.ObjectId_INVALID", "2002-400"),
    OBJECT_ID_NOT_FOUND_EXCEPTION("com.dena.platform.restapi.exception.ObjectId_NOT_FOUND", "2003-400"),
    FIELD_NOT_FOUND_EXCEPTION("com.dena.platform.restapi.exception.FIELD_TYPE_NOT_FOUND", "2004-400"),

    // User Management exception - range 3000-4000
    USER_ALREADY_EXIST_EXCEPTION("com.dena.platform.restapi.exception.USER_ALREADY_EXIST", "3000-400");
